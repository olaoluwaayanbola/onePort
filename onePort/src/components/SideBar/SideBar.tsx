  ...
  return (
    <div className={SideBarStyle.Container}>
      <div className={SideBarStyle.LogoBox}>
        <img src={Logo} className={SideBarStyle.LogoStyle} alt="onePortLogo" />
      </div>
      <nav>
        {Links_Path.map((LinkItems: LinkTypes): any => (
          <div className={SideBarStyle.LinkBox} key={LinkItems.name}>
            <NavLink
              to={LinkItems.path}
            ...
            >
              ...
              <div className={SideBarStyle.NameStyling}>{LinkItems.name}</div>
            </NavLink>
          </div>
        ))}
      </nav>
